...
for file in csvfilelist:
    with open(f'/Volumes/GoogleDrive/My Drive/Research/Structured data from text/tools/data/for rezvan/csv/' + file) as csv_file:
...
f_file = open(f'/Volumes/GoogleDrive/My Drive/Research/Structured data from text/tools/data/for rezvan/csv/papers_abstract.csv', mode='a')
